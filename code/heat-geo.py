...
map_fig = px.scatter_mapbox(combined_data, lon='long', lat='lat', color='Tmax_Summer',
                            ...
                            title='Geospatial Distribution of Maximum Summer Temperature Over Time',
                            animation_frame='year', color_continuous_scale=px.colors.sequential.Sunsetdark, size_max=13, zoom=zoom_level,
